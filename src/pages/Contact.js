                ...
                <div className="grid grid-cols-1 md:grid-cols-2 md:gap-x-10 md:px-5 my-5 ">
                    <div>
                        ...
                        <p className="text-lg font-normal my-5">
                            This is Herman Brooks. Herman is just like the rest
                            of us. Everyday he has to make all kinds of
                            decisions like what to wear, whom to date and when
                            to panic.
                        </p>

                        <p className="text-lg font-normal my-5">
                            Now these decisions should be easy but if you take a
                            look inside Herman’s head, you'll see why he
                            sometimes has trouble making up his mind. Sometimes
                            they agree… usually they don’t. But the struggle is
                            going on inside all of us and it’s all going on
